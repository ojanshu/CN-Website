          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-2 inline-block text-left">
              <li className="flex items-center">
                ...
                <a href="mailto:info@example.com" className="hover:text-orange-500 transition duration-300">info@example.com</a>
              </li>
              <li className="flex items-center">
                <MdPhone className="mr-2 text-orange-500" />
                <a href="tel:+1234567890" className="hover:text-orange-500 transition duration-300">+</a>
              </li>
              <li className="flex items-center">
